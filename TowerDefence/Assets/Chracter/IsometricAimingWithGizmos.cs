...
namespace BarthaSzabolcs.IsometricAiming
{
    public class IsometricAimingWithGizmos : MonoBehaviour
    {
        ...
        private void Shoot()
        {
            ...
            {
                // var (success, position) = GetMousePosition();   // for on click turn XD
                // var direction = position - aimedTransform.position;  //   for on click turn XD
                // aimedTransform.forward = direction;   //   for on click turn XD
